...
#ifndef FLATBUFFERS_GENERATED_NEWBLOCKINFO_PROTOCOL_H_
#define FLATBUFFERS_GENERATED_NEWBLOCKINFO_PROTOCOL_H_
...
struct NewBlockBuilder {
  ...
  void add_Length(int32_t Length) {
    fbb_.AddElement<int32_t>(NewBlock::VT_LENGTH, Length, 0);
  }
...
#endif  // FLATBUFFERS_GENERATED_NEWBLOCKINFO_PROTOCOL_H_
